...
<AppShell>
	<svelte:fragment slot="header">
		...
		>
			...
			<svelte:fragment slot="trail">
				...
				<a class="btn btn-sm variant-ghost-surface hidden sm:block" href="/" rel="noreferrer">
					Portfolio
				</a>
				<a class="btn btn-sm variant-ghost-surface hidden sm:block" href="/about" rel="noreferrer">
					Om mig
				</a>
				...
				<div data-popup="userMenuPopup">
					<div class="borderborder-gray-400 card mr-3 mt-3 w-40 space-y-2 p-4 shadow-xl">
						<a class="btn variant-ghost w-full sm:hidden" href="/" rel="noreferrer"
							>Portfolio</a
						>
						<a class="btn variant-ghost w-full sm:hidden" href="/about" rel="noreferrer"
							>Om mig</a
						>
					</div>
				</div>
	...
	<div class="pb-96 m-5 sm:ml-16 sm:mr-16 sm:mt-10 md:ml-40 md:mr-40 2xl:ml-64 2xl:mr-64">
		<slot />
	</div>
</AppShell>
